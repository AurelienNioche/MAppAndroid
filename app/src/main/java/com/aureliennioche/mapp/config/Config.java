...
public class Config {
    ...
    public static final String websocketUrl="wss://60c6-2001-630-40-70e0-00-88e6.ngrok-free.app/ws"; //TODO: Be sure to set that correctly for production
    ...
    public static long serverUpdateRepeatIntervalWhenAppOpened = 30;
}
