...
public class Config {
    ...
    public static final String websocketUrl="wss://d568-86-21-131-126.ngrok-free.app/ws"; //TODO: Be sure to set that correctly for production
    public static String appVersion = "2023.08.08";
    public static long delaySendRetry = TimeUnit.SECONDS.toMillis(15);
    public static long delayServerReconnection = TimeUnit.SECONDS.toMillis(15); // TODO This should be 30 for production
    ...
    public static long serverUpdateRepeatInterval = TimeUnit.MINUTES.toMillis(15);
    public static long serverUpdateRepeatIntervalWhenAppOpened = TimeUnit.SECONDS.toMillis(5);
    //TODO: Check as well the `ConfigUnity` settings
}
